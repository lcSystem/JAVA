...
import com.creditos.dto.CoDebtorProfileDTO;

public class CoDebtorMapper {
    public static com.creditos.domain.model.CoDebtorProfile toDomain(
            com.creditos.model.CoDebtorProfile entity) {
        if (entity == null)
            return null;
        return com.creditos.domain.model.CoDebtorProfile.builder()
                .id(entity.getId())
    ...
    public static com.creditos.model.CoDebtorProfile toEntity(
            com.creditos.domain.model.CoDebtorProfile domain) {
        if (domain == null)
            return null;
        return com.creditos.model.CoDebtorProfile.builder()
                .id(domain.getId())
    ...
    public static CoDebtorProfileDTO toDTO(com.creditos.domain.model.CoDebtorProfile domain) {
        if (domain == null)
            return null;
    ...
    public static com.creditos.domain.model.CoDebtorProfile toDomain(CoDebtorProfileDTO dto) {
        if (dto == null)
            return null;
        return com.creditos.domain.model.CoDebtorProfile.builder()
                .id(dto.getId())
