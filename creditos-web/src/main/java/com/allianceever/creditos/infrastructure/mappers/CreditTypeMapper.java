...
public class CreditTypeMapper {
    public static CreditType toDomain(com.allianceever.creditos.model.CreditType entity) {
        if (entity == null)
            return null;
    ...
    public static com.allianceever.creditos.model.CreditType toEntity(CreditType domain) {
        if (domain == null)
            return null;
        com.allianceever.creditos.model.CreditType entity = new com.allianceever.creditos.model.CreditType();
