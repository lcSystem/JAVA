...
public class FileController {
    ...
    public ResponseEntity<InputStreamResource> downloadFile(
        ...
        return ResponseEntity.ok()
                ...
                .contentType(MediaType.parseMediaType(
                        fileMeta.getMimeType() != null ? fileMeta.getMimeType() : "application/octet-stream"))
    ...
    public ResponseEntity<Page<FileResponse>> listByFolder(
        ...
        log.info("LIST BY FOLDER DEBUG: Requesting files for folder {} and owner {}", folderId, getOwnerId(jwt));
    ...
    public ResponseEntity<FileResponse> moveFile(
        ...
        return ResponseEntity.ok(toResponse(fileUseCase.moveFile(id, request.getTargetFolderId(), getOwnerId(jwt))));
    }
