...
public class InvoiceController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EstimatesInvoicesDto> getInvoiceById(@PathVariable("id") Long invoiceID) {
    ...
    @PostMapping("/create")
    public ResponseEntity<EstimatesInvoicesDto> createInvoice(@ModelAttribute EstimatesInvoicesDto estimatesInvoicesDto,
    ...
    public ResponseEntity<EstimatesInvoicesDto> updateInvoice(
            @ModelAttribute EstimatesInvoicesDto estimatesInvoicesDto) {
        Long invoiceID = estimatesInvoicesDto.getId();
        EstimatesInvoicesDto existingInvoice = estimatesInvoicesService.getById(invoiceID);
        if (existingInvoice == null) {
            return ResponseEntity.notFound().build();
        }
        // Perform a partial update of the existingInvoice using the
        // estimatesInvoicesDto data
